...
import com.projete.telasprojete.databinding.TelaFotoPerfilBinding

class FotoPerfilActivity : ComponentActivity() {


    val Tag: String = "FIRESTORE"
    val fireStoreDatabase = FirebaseFirestore.getInstance()

    private lateinit var binding: TelaFotoPerfilBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = TelaFotoPerfilBinding.inflate(layoutInflater)
