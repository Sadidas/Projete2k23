...
import com.projete.telasprojete.databinding.TelaFotoMecBinding

class FotoMecActivity : ComponentActivity() {


    val Tag: String = "FIRESTORE"
    val fireStoreDatabase = FirebaseFirestore.getInstance()

    private lateinit var binding: TelaFotoMecBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = TelaFotoMecBinding.inflate(layoutInflater)
            ...
            fireStoreDatabase.collection("Usuarios")
                ...
                .addOnCompleteListener {
                    ...
                    if (it.isSuccessful){
                        ...
                        if(tem){
                            val intent = Intent(this, OficinaActivity::class.java)
        ...
        binding.btnUpload.setOnClickListener {
            ...
            currentFile?.let { file ->
                ...
                val imageRef = storageRef.child("oficina/$uid")
                ...
                uploadTask.addOnSuccessListener { taskSnapshot ->
                    imageRef.downloadUrl.addOnSuccessListener { uri ->
                        ...
                        val intent = Intent(this, FotoPerfil1Activity::class.java)
                        startActivity(intent)
                        finish()
