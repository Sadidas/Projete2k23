...
import com.projete.telasprojete.databinding.TelaFotoPerfil1Binding

class FotoPerfil1Activity : ComponentActivity() {


    val Tag: String = "FIRESTORE"
    val fireStoreDatabase = FirebaseFirestore.getInstance()

    private lateinit var binding: TelaFotoPerfil1Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = TelaFotoPerfil1Binding.inflate(layoutInflater)
        ...
        binding.btnUpload.setOnClickListener {
            ...
            currentFile?.let { file ->
                ...
                val imageRef = storageRef.child("perfil/$uid")
